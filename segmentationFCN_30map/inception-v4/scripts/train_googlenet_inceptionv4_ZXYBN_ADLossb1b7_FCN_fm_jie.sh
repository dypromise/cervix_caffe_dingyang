...
LOG=$model_dir/logs/inceptionv4_tryZXYBN_ADLossb1b7_FCN_fm40000jie.log
MV2_USE_CUDA=1 MV2_ENABLE_AFFINITY=0 MV2_SMP_USE_CMA=0 \
	...
	--solver=$model_dir/solver_v4_FCN_fm_jie.prototxt \
	--weights=/mnt/lustre/dingyang/cervix_caffe_dingyang/myself/inception-v4/savedCaffemodels/FCN_fm/iv4_FCN_fm__iter_40000.caffemodel \
   	2>&1 |tee $LOG
