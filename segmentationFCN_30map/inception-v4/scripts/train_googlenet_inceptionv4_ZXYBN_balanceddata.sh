...
LOG=$model_dir/logs/inceptionv4_tryZXYBN_balanceddata_jie23000.log
MV2_USE_CUDA=1 MV2_ENABLE_AFFINITY=0 MV2_SMP_USE_CMA=0 \
	...
	--solver=$model_dir/solver_v4_ZXYBN_balanced_jie.prototxt \
	--weights=/mnt/lustre/dingyang/cervix_caffe_dingyang/myself/inception-v4/savedCaffemodels/iv4_ZXYBN_balanced__iter_23000.caffemodel \
   	2>&1 |tee $LOG
