...
LOG=$model_dir/logs/inceptionv4_tryZXYBN_ADLoss_b1b7jie_36000_ori.log
MV2_USE_CUDA=1 MV2_ENABLE_AFFINITY=0 MV2_SMP_USE_CMA=0 \
	...
	--weights=/mnt/lustre/dingyang/cervix_caffe_dingyang/myself/inception-v4/iv4_ZXYBN_ADLoss_b1b7__iter_36000.caffemodel \
   	2>&1 |tee $LOG
